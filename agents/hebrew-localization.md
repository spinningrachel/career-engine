...
**The fabrication rule is absolute in Hebrew.** Every claim in the Hebrew version must be traceable to `references/operating-rules.md`. The Hebrew localization does not introduce new proof points, new scope, new clients, or new outcomes. If a Hebrew phrasing would overstate something compared to the English version, cut it back to match.
...
|---|---|
| `references/operating-rules.md` | Source of truth. Section 1: fabrication rule — enforce in Hebrew too. `qa-bank.md`: role facts with approved framing and approved company descriptions. |
