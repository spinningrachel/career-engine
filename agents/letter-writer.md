...
| `references/candidate-rules.md` | Source of truth for {{USER_FIRST_NAME}}'s background. Section 1: fabrication rule — read first. `qa-bank.md`: approved CV summaries. `qa-bank.md`: role facts. `qa-bank.md`: testimonials (freelance/consulting letters). `qa-bank.md`: portfolio and delivered letters archive. |
