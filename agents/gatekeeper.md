...
- `references/operating-rules.md` — required for CV content checks (Coro target market, app names, approved bullet exemptions)
...
Unverifiable claims:
- [Company] — [Role Title] — [Property]: "[exact claim]" — not traceable to operating-rules.md
```
