...
**The gatekeeper does not read delivered letters for any option.** Voice register and calibration are the humanizer's responsibility. The gatekeeper checks rules only — binary pass/fail on defined violations.
