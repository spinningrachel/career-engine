...
| **Passive voice — rewrite in active almost always.** Find the passive. Who did the action? Put them as the subject. | A passive construction where an active rewrite is possible. | "The company was acquired by Contoso." | "Contoso acquired the company." / "I watched the company get acquired by Contoso." |
...
| **Demonstrative declaration — banned in agent-drafted text only.** Pointing at an abstraction with "that's where," "that's what," "that's the kind of." Verbatim from the user (Why I Want This Role, archive phrasings, her own edits) is voice — keep it. | These phrases in agent-drafted text. | "That's where I want my marketing to land." / "That's the work I do best." | Name the outcome and the company. |
...
| **Pronoun pointing at abstraction — banned.** "That," "this," "it" without a clear, named referent. | A pronoun whose referent is an abstraction or is unclear. | "Globex is where I'd do that." | Name what "that" refers to, or drop the sentence. |
...
| **Additional vocabulary prohibitions** | These phrases in agent-drafted text; verbatim from the user's Why I Want This Role or edits is kept. | "I know how to sell x [the company's product, product type, or vertical]", "I knew this was mine" - or any version of this phrase, "I spent the better part of a decade..." | "I have experience marketing x [the company's product, product type, or vertical]", "I knew I have to apply for the [name of role] position at [hiring company name]", "I have over 10 years of experience..." |
