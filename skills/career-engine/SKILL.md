...
| 12 | Technical writer | "write documentation for...", "draft a README", "create a PRD", "document this API", "write a runbook", "edit this doc", "review this documentation", "write a tutorial", "create an SOP" | `technical-writer` | none | none | Never writes to Notion; never touches career pipeline outputs |
