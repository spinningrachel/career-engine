...
4. All cv-campaign skills are loaded, including candidate-rules.md.
...
- **Fabrication rule is absolute.** See candidate-rules.md. Editing does not license invention.
