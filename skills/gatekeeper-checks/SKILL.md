...
- **No manufactured passion hierarchy** (`writer-craft/SKILL.md` §10): a superlative preference claim — "what I care about most," "the work I love most," "nothing excites me more," or any construction ranking one interest above the rest of her field — unless verbatim in WIWTR or the Motivation Bank. The personal-content exemption covers verbatim matches only, never a paraphrase that escalates a documented interest (e.g. a PLG-tagged Bank entry) into a superlative she has never stated. **Hard fail.**
