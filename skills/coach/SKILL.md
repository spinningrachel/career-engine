...
**Mandatory load:**
- `candidate-rules.md` — Section 1 contains rules and guardrails. This supersedes anything you think you know about {{USER_FIRST_NAME}} from prior context. Role facts and approved bullets are in `qa-bank.md`.
