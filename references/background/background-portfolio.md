---
name: portfolio
description: Portfolio, work samples, and the delivered-letters archive pointer. Load when writing proposals and cover letters that benefit from referencing specific work samples.
---

# Portfolio and Work Samples

**Delivered letters archive:** `references/delivered-letters/` (inside the plugin; cap 6, managed via letter-writer Option 3) — cover letters approved and sent, exactly as sent. These are the highest-fidelity voice anchors available. When writing a cover letter, read any letters for similar domains or role types before writing.
